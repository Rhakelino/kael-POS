                ...
                <div className="w-full lg:w-64 shrink-0 space-y-4">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                            ...
                            className="p-1 rounded bg-slate-200 text-slate-500 hover:text-primary transition-colors"
                        >
                    ...
                    <div className="flex lg:flex-col gap-2 lg:gap-1 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide">
                        <button
                            ...
                            className={`shrink-0 flex items-center justify-between px-4 py-2.5 rounded-lg text-sm font-bold min-w-[140px] lg:min-w-0 transition-colors ${selectedCategory === null
                                ...
                                : "bg-white lg:bg-transparent border border-slate-200 lg:border-none lg:hover:bg-slate-200 text-slate-600"
                                }`}
                        >
                    ...
                    {isLoading ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            {filteredProducts.map((product) => (
                                <div
                                    key={product.id}
                                    className={`bg-white p-4 rounded-xl border border-slate-200 shadow-sm group ${!product.isActive ? "opacity-60" : ""
                                        }`}
                                >
                                    <div
                                        className={`aspect-square rounded-lg mb-4 bg-center bg-cover bg-slate-100 overflow-hidden relative ${!product.isActive ? "grayscale" : ""
                                            }`}
                                        style={{
                                    ...
                                    <div className="flex items-start justify-between">
                                        ...
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            ...
                                            />
                                            <div className="w-8 h-4 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-[16px] peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:bg-primary"></div>
                                        </label>
                                    </div>
                                    {product.description && (
                        ...
                        {imagePreview ? (
                            <div className="relative group">
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity rounded-xl flex items-center justify-center gap-2">
                                    <label className="cursor-pointer px-3 py-1.5 bg-white rounded-lg text-xs font-bold text-slate-700 hover:bg-slate-100 transition-colors">
                                        Change
                                        <input
                                            type="file"
                                            accept="image/*"
                            ...
                            <label className="cursor-pointer flex flex-col items-center justify-center h-32 border-2 border-dashed border-slate-200 rounded-xl hover:border-primary/40 hover:bg-primary/5 transition-all">
                                {uploading ? (
                                    <div className="w-6 h-6 border-3 border-primary/30 border-t-primary rounded-full animate-spin"></div>
                                ) : (
                                    <>
