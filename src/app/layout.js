...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body suppressHydrationWarning className={`${inter.variable} antialiased font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-white`}>
